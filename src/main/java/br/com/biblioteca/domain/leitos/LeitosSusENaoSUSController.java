...
public class LeitosSusENaoSUSController {
    ...
    public LeitosSusENaoSUSController(LeitosSusENaoSUSService leitosSusENaoSUSService, LeitosSusENaoSUSMapper leitosSusENaoSUSMapper) {
        this.leitosSusENaoSUSService = leitosSusENaoSUSService;
        this.leitosSusENaoSUSMapper = leitosSusENaoSUSMapper;
    }

    @GetMapping("/{id}")
    @Operation(summary = "Search Leitos SUS and Não SUS data by ID")
    public ResponseEntity<ApplicationResponse<LeitosSusENaoSUSDTO>> findById(@PathVariable Long id) {
